...
-(id) init{
    if(self = [super init]){
        ...
        CCSprite* statsSprite = [CCSprite spriteWithFile:@"stats.png"];
        ...
        CCLabelBMFont* punchQLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Punch.Q:  %.02f",punchQ] fontName:@"Marker Felt" fontSize:labelFontSize];
        CCLabelBMFont* bestStreakLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Best StreaQ:  %d",bestStreak] fontName:@"Marker Felt" fontSize:labelFontSize];
        CCLabelBMFont* averageLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Average:  %.02f",averagePunches] fontName:@"Marker Felt" fontSize:labelFontSize];
        CCLabelBMFont* totalPunchesLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Total Punches:  %d",totalPunches] fontName:@"Marker Felt" fontSize:labelFontSize];
        CCLabelBMFont* totalCoinsLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Total Coins:  %.f",totalCoins] fontName:@"Marker Felt" fontSize:labelFontSize];
        CCLabelBMFont* multiplierLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Multiplier:  %0.1f",multiplier] fontName:@"Marker Felt" fontSize:labelFontSize];
        ...
        [totalPunchesLabel setPosition:ccp(screenSize.width/2,screenSize.height * 0.45f)];
        [totalCoinsLabel setPosition:ccp(screenSize.width/2,screenSize.height * 0.35f)];
        [multiplierLabel setPosition:ccp(screenSize.width/2,screenSize.height * 0.25f)];
